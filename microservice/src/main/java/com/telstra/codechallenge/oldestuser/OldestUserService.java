...
public class OldestUserService {
    ...
    private String oldestUserQuery="q=followers:0&sort=joined&order=asc&page=1&per_page=";
    ...
    public OldestUser getOldestUser(int accountNumber) {
        return restTemplate.getForObject(githubSearchUrl+oldestUserQuery+accountNumber, OldestUser.class);
    }
